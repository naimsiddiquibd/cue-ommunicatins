        ...
        <div className="row">
          <div className="col-lg-5 valign">
            <div className="content wow fadeInUp md-mb30" data-wow-delay=".5s">
              ...
              Skills that Set Us Apart: Elevating Every Project Beyond Expectations
              </h3>
              <p>
              Innovative design and seamless project management, redefining excellence in every step of your journey.
              </p>

        ...
        <div className="row">
          ...
          <div className="col-lg-5 valign">
            <div className="cont full-width">
              <h3 className="color-font">Creative Design Concepts</h3>
              ...
              <div className="skills-box mt-40">
                <div className="skill-item">
                  <h5 className="fz-14 mb-15">Creative Design Concepts</h5>
                  <div className="skill-progress">
                    <div className="progres" data-value="90%"></div>
                  </div>
                </div>
                <div className="skill-item">
                  <h5 className="fz-14 mb-15">Efficient Project Management</h5>
                  <div className="skill-progress">
